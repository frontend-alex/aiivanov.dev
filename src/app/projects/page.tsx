...
export default function ProjectsPage() {
  ...
  return (
    <main
      ref={containerRef}
      className="flex flex-col lg:fixed gap-10 lg:inset-0 lg:overflow-hidden touch-none"
    ...
    >
      ...
      {/* Track */}
      <div className="hidden lg:flex flex-1 w-full lg:items-center overflow-hidden pt-10 lg:pt-0 pointer-events-none">
        <motion.div
      ...
      {/* Mobile Projects */}
      <div className="flex lg:hidden flex-col items-center gap-3 px-5">
