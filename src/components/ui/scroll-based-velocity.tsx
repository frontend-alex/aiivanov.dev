...
function ScrollVelocityRowImpl({
  ...
  const handlePointerDown = (e: React.PointerEvent) => {
    ...
    dragStartValueRef.current = baseX.get()
  ...
  const handlePointerMove = (e: React.PointerEvent) => {
    ...
    baseX.set(dragStartValueRef.current - delta)
  }
  ...
  useAnimationFrame((_, delta) => {
    ...
    if (isDraggingRef.current) return // drag overrides auto-scroll
  ...
  return (
    ...
    >
      <motion.div
        className="inline-flex transform-gpu items-center will-change-transform cursor-grab active:cursor-grabbing"
        style={{ x }}
